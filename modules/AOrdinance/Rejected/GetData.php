<?php
	...
	if(isset($_POST['type']))
	{
        ...
        if($type == "GETALLREJECTEDORDINANCE")
		{
            $brgycode = "";
            $brgyname = "";
            $ordinanceno = "";
            ...
            $createddate = "";
            $createdtime = "";
			$rejectedordinancedata_arr = array();
            ...
            $ordinanceMstrRowQuery = "SELECT
                ...
                WHERE
                    UPPER( ordinance_mstr.STATUS ) = 'REJECTED' 
                ORDER BY
			...
			if($ordinanceMstrResult != NULL)
			{
				...
				{  
                    ...
                    $rejectedordinancedata_arr[] = $nestedData;
				}
            }
            ...
            $json_data = array(
				...
				"data"            => $rejectedordinancedata_arr   // total data array
			);
