...
<html lang = "en">
	...
	<body class = "loading" data-layout-config = '{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title"> List Of Pending Ordinance </h4>
                                </div>
                            </div>
                        </div>   
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "card">
                                    <div class = "card-body">
                                        <table id = "tblPendingOrdinance" class = "table table-bordered table-striped dt-responsive nowrap w-100" style = "font-size: 12px;">
                                            <thead>
                                                <tr>
		...
		<?php include $common_path."AOrdinance/Pending/PendingOrdinanceJs.php"; ?>
	</body>
</html>