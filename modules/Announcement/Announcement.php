                    ...
                    <div class = "container-fluid">
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "card">
                                    <div class = "card-body">
                                        <form action = "#" method = "POST" id = "fCreateAnnouncement" role = "form">
                                            <div class = "row">
                                                <div class = "col-md-8">
                                                    <div class = "mb-3">
                                                ...
                                                <div class = "col-md-4">
                                                    <div class = "mb-3">
                                                        ...
                                                        <input type = "file" id = "file" name = "file" class = "form-control" accept = ".doc, .docx, .pdf, image/*"> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class = "row">
                                            ...
                                            <div class = "text-end">
                                                <button id = "btnSave" class = "btn btn-success" title = "Save Announcement">
