<?php
	...
	if(isset($_POST['type']))
	{
        ...
        if($type == "GETALLAPPROVEDORDINANCE")
		{
            $brgycode = "";
            $brgyname = "";
            $ordinanceno = "";
            ...
            $createddate = "";
            $createdtime = "";
			$approvedordinancedata_arr = array();
            ...
            $ordinanceMstrRowQuery = "SELECT
                ...
                WHERE
                    UPPER( ordinance_mstr.STATUS ) = 'APPROVED' 
                ORDER BY
			...
			if($ordinanceMstrResult != NULL)
			{
				...
				{  
                    ...
                    $approvedordinancedata_arr[] = $nestedData;
				}
            }
            ...
            $json_data = array(
				...
				"data"            => $approvedordinancedata_arr   // total data array
			);
