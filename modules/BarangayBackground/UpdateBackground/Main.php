<?php
    ...
    include $modules_path."BarangayBackground/UpdateBackground/Info.php";
?>
<!DOCTYPE html>
<html lang = "en">
	<title> UPDATE BARANGAY BACKGROUND </title>
	...
	<body class = "loading" data-layout-config = '{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class = "row">
                            <div class = "col-12">
                                <div class = "page-title-box">
                                    ...
                                    <h4 class = "page-title"> Update Barangay Background </h4>
                                </div>
                            </div>
                        </div>     
                        <div class = "row">
                            <div class = "col-xl-4 col-lg-5">
                                <div class = "card text-center">
                                    <div class = "card-body">
                                        <img id = "txtBarangayProfile" src = "assets/images/barangay/<?php echo $profile ?>" class = "rounded-circle avatar-xl img-thumbnail" alt = "profile-image">
                                        <br>
                                        <br>
                                            ...
                                            <div class = "row">
                                                <div class = "col-md-6">
                                                    <div class = "mb-3">
                                                        ...
                                                        <input type = "email" id = "txtEmail" name = "txtEmail" class = "form-control" placeholder = "Enter barangay email address" value = "<?php echo $email ?>" required>
                                                    </div>
                                                </div>
                                                <div class = "col-md-6">
                                                    <div class = "mb-3">
                                                        <label for = "mobile" class = "form-label"> Mobile Number <b style = "color:red">*</b></label>
                                                        <input type = "text" id = "txtMobileNumber" name = "txtMobileNumber" class = "form-control" placeholder = "Enter barangay mobile number" value = "<?php echo $mobile ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class = "row">
                                                <div class = "col-md-6">
                                                    <div class = "mb-3">
                                                        ...
                                                        <input type = "text" id = "txtTelephoneNumber" name = "txtTelephoneNumber" class = "form-control" placeholder = "Enter barangay telephone number" value = "<?php echo $telephone ?>">
                                                    </div>
                                                </div>
                                                <div class = "col-md-6">
                                                    <div class = "mb-3">
                                                        ...
                                                        <div class = "input-group">
                                                            ...
                                                            <input type = "text" id = "txtFacebook" name = "txtFacebook" class = "form-control" placeholder = "Url" value = "<?php echo $facebook ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class = "row">
                                                <div class = "col-md-12">
                                                    <div class = "mb-3">
                                                        ...
                                                        <textarea id = "txtBarangayBackground" name = "txtBarangayBackground" class = "form-control" rows = "6" placeholder = "Enter some brief about your barangay" required><?php echo $bio ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class = "text-end">
		...
		<?php include $common_path."BarangayBackground/UpdateBackground/UpdateBackgroundJs.php"; ?>
	</body>
</html>